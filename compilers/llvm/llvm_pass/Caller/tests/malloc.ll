...
define dso_local i32 @main() local_unnamed_addr #2 !dbg !57 {
  %1 = tail call noalias dereferenceable_or_null(16) ptr @malloc(i64 noundef 16) #7, !dbg !65
  call void @llvm.dbg.value(metadata ptr %1, metadata !61, metadata !DIExpression()), !dbg !66
  %2 = tail call noalias dereferenceable_or_null(32) ptr @malloc(i64 noundef 32) #7, !dbg !67
...
21:                                               ; preds = %8, %0
  ...
  tail call void @free(ptr noundef %2) #8, !dbg !96
  tail call void @free(ptr noundef %1) #8, !dbg !97
  ret i32 0, !dbg !98
}
