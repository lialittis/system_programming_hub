; ModuleID = 'hello_input.cpp'
source_filename = "hello_input.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_hello_input.cpp, ptr null }]
...
define dso_local void @_Z8simpleIOi(i32 noundef %0) #4 {
...
define dso_local noundef i32 @main() #5 {
  ...
  call void @_Z8simpleIOi(i32 noundef 10)
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_hello_input.cpp() #0 section ".text.startup" {
